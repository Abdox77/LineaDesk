...
export function RegisterCard()
{
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (data.status === 201) {
                navigate ('/login', {
                    state: { message: 'Registration succesful! Please log in.' }
                });
            } else {
   ...
   return (
        ...
        >
            ...
            <div className="flex flex-col gap-4">
                ...
                <div className="flex flex-col gap-2">
                    <div className="flex justify-between items-center">
                        <label className="text-gray-900 dark:text-white text-sm font-semibold leading-normal">Confirm Password</label>
                    </div>
                    <div className="relative">
                        <span className="material-symbols-outlined absolute left-3 top-1/2 -translate-y-1/2 text-gray-500 dark:text-[#9cb0ba] text-xl">lock</span>
                        <input 
